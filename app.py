...
#     st.markdown("<h2>Smart Email Assistant 🚀</h2>", unsafe_allow_html=True)
...
#         st.markdown("- Fallback to Hugging Face if no key")
#         st.markdown("- Tone detection and override")
#         st.markdown("- Named Entity Recognition")
#         st.markdown("- Regenerate last response")

#     st.subheader("📝 Input Email Thread")
#     email_thread = st.text_area("Paste email thread (latest at top)", height=200)
#     additional_context = st.text_area("Additional context (optional)", height=100)

#     if email_thread:
#         lang = detect_language(email_thread)
#         if lang != 'en':
#             st.warning(f"Detected language: {lang.upper()}. Responses will be in English.")
        
        

#     selected_tone = st.selectbox("Select tone", ["Professional", "Casual", "Friendly", "Formal"])
...
#         st.markdown("---")
#         st.subheader("✨ Generated Content and Insights")
#         st.markdown("**Subject:**")
...
#         with st.expander("🔍 Named Entity Recognition (Input)"):
#             st.table(named_entity_recognition(email_thread))
#         with st.expander("🔍 Named Entity Recognition (Reply)"):
#             st.table(named_entity_recognition(content['response']))

#         st.download_button("Download Reply", content['response'], file_name="reply.txt")
#         st.download_button("Download Summary", content['summary'], file_name="summary.txt")
